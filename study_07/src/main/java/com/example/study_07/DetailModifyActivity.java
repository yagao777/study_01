...
public class DetailModifyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(SP_DETAIL, DetailModifyActivity.MODE_PRIVATE);
