...
public class PoetryAppreciationFragment extends Fragment {
    ...
    // 一般的写法如下
    // 实例化方法
    public static PoetryAppreciationFragment newInstance(PoetryDynamicModel model){
        Bundle bundle = new Bundle();
        // bundle 和Intent很类似，我们可以将各种各样的数据放到其中
        // bundle.putString("key","value");
        bundle.putParcelable(POETRY_MODEL,model);

        PoetryAppreciationFragment fragment = new PoetryAppreciationFragment();
        // 将数据放到Fragment中
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_poertry_appreciation, container, false);
    }
